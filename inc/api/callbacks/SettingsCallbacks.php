...
class SettingsCallbacks extends BaseCallbacks
{
    ...
    public function pusheSettingsSection()
    {
        ...
        $output .= '<li>' . esc_html__("To figure out how to find your page numbers, checkout ", "pushe-webpush") . '<a href="https://docs.pushe.co/docs/wordpress/intro/" target="_blank">' . esc_html__("our documentations", "pushe-webpush") . '</a></li>';
        $output .= '</ul>';
